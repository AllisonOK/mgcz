...
public class PortraitCropActivity extends AppCompatActivity {


    private static final String TAG = "PortraitCropActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portrait_crop);
    ...
    private void initView() {
        ...
        cancelTv = (TextView) this.findViewById(R.id.weixin_act_crop_tv_cancel);
